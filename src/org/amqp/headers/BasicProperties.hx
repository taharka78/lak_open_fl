...
/*
        ...
        public var headers(getHeaders, setHeaders) : Array<Dynamic>;
        ...
        public function getHeaders():Array<Dynamic>{return _headers;}
        ...
        public function setHeaders(x:Array<Dynamic>):Array<Dynamic>{_headers = x;	return x;}
