...
int color = __o_color.Default(0);
{
	...
	HX_STACK_LINE(29)
	::openfl::text::TextFormat tmp2 = ::openfl::text::TextFormat_obj::__new(HX_HCSTRING("_sans","\x32","\xa0","\x5e","\xff"),(int)12,color,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(29)
	...
	HX_STACK_LINE(35)
	Dynamic tmp3 = this->this_onEnterFrame_dyn();		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(35)
