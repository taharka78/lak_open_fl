...
bool Sprite_obj::__hitTest( Float x,Float y,bool shapeFlag,Array< ::Dynamic > stack,bool interactiveOnly,::openfl::display::DisplayObject hitObject){
	...
	if ((tmp1)){
		...
		if ((tmp5)){
			HX_STACK_LINE(71)
			::openfl::display::Sprite tmp7 = this->hitArea;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(71)
			::openfl::display::Sprite tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(71)
			...
			HX_STACK_LINE(71)
			::openfl::display::DisplayObject tmp13 = hitObject;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(71)
			Float tmp14 = tmp9;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(71)
			Float tmp15 = tmp10;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(71)
			bool tmp16 = tmp11;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(71)
			bool tmp17 = tmp12;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(71)
			::openfl::display::DisplayObject tmp18 = tmp13;		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(71)
			tmp6 = tmp8->__hitTest(tmp14,tmp15,tmp16,stack,tmp17,tmp18);
		}
		else{
			HX_STACK_LINE(71)
			tmp6 = false;
		...
		if ((tmp6)){
			HX_STACK_LINE(73)
			int tmp7 = (stack->length - (int)1);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(73)
			::openfl::display::DisplayObject tmp8 = hitObject;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(73)
			stack[tmp7] = tmp8;
			HX_STACK_LINE(74)
			return true;
...
bool Sprite_obj::__hitTestMask( Float x,Float y){
	HX_STACK_FRAME("openfl.display.Sprite","__hitTestMask",0x9c046ff2,"openfl.display.Sprite.__hitTestMask","openfl/display/Sprite.hx",106,0xd5438ced)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(108)
...
::openfl::display::Graphics Sprite_obj::get_graphics( ){
	HX_STACK_FRAME("openfl.display.Sprite","get_graphics",0x451134b3,"openfl.display.Sprite.get_graphics","openfl/display/Sprite.hx",130,0xd5438ced)
	HX_STACK_THIS(this)
	HX_STACK_LINE(132)
...
bool Sprite_obj::get_tabEnabled( ){
	HX_STACK_FRAME("openfl.display.Sprite","get_tabEnabled",0x5c66fc94,"openfl.display.Sprite.get_tabEnabled","openfl/display/Sprite.hx",144,0xd5438ced)
	HX_STACK_THIS(this)
	HX_STACK_LINE(146)
