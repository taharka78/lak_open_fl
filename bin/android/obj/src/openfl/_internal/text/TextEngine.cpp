	...
	if ((tmp1)){
		...
		HX_STACK_LINE(249)
		{
			...
			if (  ( _switch_2==HX_HCSTRING("_sans","\x32","\xa0","\x5e","\xff"))){
				HX_STACK_LINE(284)
				::String tmp10 = (systemFontDirectory + HX_HCSTRING("/DroidSans.ttf","\xf8","\xc6","\x8e","\x4f"));		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(284)
				fontList = Array_obj< ::String >::__new().Add(tmp10);
			}
			else if (  ( _switch_2==HX_HCSTRING("_serif","\xbe","\x66","\x15","\x76"))){
			}
			else if (  ( _switch_2==HX_HCSTRING("_typewriter","\x0c","\x5e","\x52","\x94"))){
				HX_STACK_LINE(326)
				::String tmp10 = (systemFontDirectory + HX_HCSTRING("/DroidSansMono.ttf","\xbb","\x6c","\x31","\x55"));		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(326)
				fontList = Array_obj< ::String >::__new().Add(tmp10);
			}
			else  {
...
;
	...
	HX_STACK_LINE(405)
	::String tmp3 = (systemFontDirectory + HX_HCSTRING("/DroidSerif-Regular.ttf","\x57","\xb0","\xef","\x46"));		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(405)
	::String tmp4 = (systemFontDirectory + HX_HCSTRING("/NotoSerif-Regular.ttf","\x59","\x73","\xf1","\x28"));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(405)
