...
::lime::_system::JNIMethod_obj::__register();
::lime::_system::JNIStaticField_obj::__register();
::lime::_system::JNIMemberField_obj::__register();
::lime::_system::JNI_obj::__register();
...
::com::lak::utils::IsoUtils_obj::__register();
::com::lak::events::MapEvent_obj::__register();
::openfl::events::Event_obj::__register();
::com::lak::entities::ai::Astar_obj::__register();
::EReg_obj::__register();
::openfl::display::DisplayObject_obj::__register();
::sys::io::_Process::Stdin_obj::__register();
::spritesheet::importers::ZoeImporter_obj::__register();
...
::com::lak::utils::GameUtils_obj::__register();
::com::lak::manager::SpritesheetManager_obj::__register();
::com::lak::manager::LevelManager_obj::__register();
::com::lak::manager::EntitiesManager_obj::__register();
::com::lak::manager::AttackMananger_obj::__register();
::com::lak::entities::IsoUnit_obj::__register();
::com::lak::entities::IsoObject_obj::__register();
::com::lak::IsoWorld_obj::__register();
::com::lak::Camera_obj::__register();
::Type_obj::__register();
::Sys_obj::__register();
...
::com::lak::entities::ai::Astar_obj::__boot();
::openfl::events::Event_obj::__boot();
::com::lak::events::MapEvent_obj::__boot();
::com::lak::utils::IsoUtils_obj::__boot();
...
::lime::_system::JNI_obj::__boot();
::lime::_system::JNIMemberField_obj::__boot();
::lime::_system::JNIStaticField_obj::__boot();
::lime::_system::JNIMethod_obj::__boot();
