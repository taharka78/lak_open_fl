...
Void System_obj::exit( int code){
{
		...
		HX_STACK_LINE(115)
		bool tmp = (code == (int)0);		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(115)
		if ((tmp)){
			HX_STACK_LINE(117)
			::lime::_system::JNIStaticField tmp1 = ::lime::_system::JNI_obj::createStaticField(HX_HCSTRING("org/haxe/extension/Extension","\xb1","\xf4","\x56","\x51"),HX_HCSTRING("mainActivity","\x28","\x83","\x72","\x14"),HX_HCSTRING("Landroid/app/Activity;","\x52","\xcb","\x53","\x45"));		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(117)
			::lime::_system::JNIStaticField mainActivity = tmp1;		HX_STACK_VAR(mainActivity,"mainActivity");
			HX_STACK_LINE(118)
			Dynamic tmp2 = ::lime::_system::JNI_obj::createMemberMethod(HX_HCSTRING("android/app/Activity","\x7d","\xf6","\xa1","\xaf"),HX_HCSTRING("moveTaskToBack","\xd8","\x80","\xa8","\x0c"),HX_HCSTRING("(Z)Z","\xc3","\xf7","\xb4","\x1a"),null(),null());		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(118)
			Dynamic moveTaskToBack = tmp2;		HX_STACK_VAR(moveTaskToBack,"moveTaskToBack");
			HX_STACK_LINE(120)
			Dynamic tmp3 = mainActivity->__Field(HX_HCSTRING("get","\x96","\x80","\x4e","\x00"), hx::paccDynamic )();		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(120)
			moveTaskToBack(tmp3,true);
		}
		HX_STACK_LINE(128)
