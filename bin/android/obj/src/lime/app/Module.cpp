...
{
		HX_STACK_FRAME("lime.app.Module","onWindowEnter",0x7463c46d,"lime.app.Module.onWindowEnter","lime/app/Module.hx",306,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowFocusIn",0xf8e4dc72,"lime.app.Module.onWindowFocusIn","lime/app/Module.hx",313,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowFocusOut",0xcf609b61,"lime.app.Module.onWindowFocusOut","lime/app/Module.hx",320,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowFullscreen",0xdd712ec6,"lime.app.Module.onWindowFullscreen","lime/app/Module.hx",327,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowLeave",0x76308c4c,"lime.app.Module.onWindowLeave","lime/app/Module.hx",334,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowMove",0x01388d5c,"lime.app.Module.onWindowMove","lime/app/Module.hx",343,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowMinimize",0xdf7b6ae9,"lime.app.Module.onWindowMinimize","lime/app/Module.hx",350,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowResize",0x664a6cff,"lime.app.Module.onWindowResize","lime/app/Module.hx",359,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
...
{
		HX_STACK_FRAME("lime.app.Module","onWindowRestore",0x2211fde3,"lime.app.Module.onWindowRestore","lime/app/Module.hx",366,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(window,"window")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","render",0xc490e692,"lime.app.Module.render","lime/app/Module.hx",373,0x653a538a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(renderer,"renderer")
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Module","update",0x466d0145,"lime.app.Module.update","lime/app/Module.hx",380,0x653a538a)
		HX_STACK_THIS(this)
