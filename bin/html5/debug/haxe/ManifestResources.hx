...
@:keep @:bind #if display private #end class __ASSET__mali_cavalier_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }@:keep @:bind #if display private #end class __ASSET__mali_general_json extends null { }
@:keep @:bind #if display private #end class __ASSET__mali_general_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }@:keep @:bind #if display private #end class __ASSET__mali_king_json extends null { }
@:keep @:bind #if display private #end class __ASSET__mali_king_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }@:keep @:bind #if display private #end class __ASSET__data_animations_json extends null { }
...
@:keep @:bind #if display private #end class __ASSET__world_grass_____png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }@:keep @:bind #if display private #end class __ASSET__world_grass___png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }@:keep @:bind #if display private #end class __ASSET__world_grass_old_json extends null { }
...
@:image("assets/world/grass----.png") #if display private #end class __ASSET__world_grass_____png extends lime.graphics.Image {}
@:image("assets/world/grass--.png") #if display private #end class __ASSET__world_grass___png extends lime.graphics.Image {}
@:file("assets/world/grass-old.json") #if display private #end class __ASSET__world_grass_old_json extends haxe.io.Bytes {}
