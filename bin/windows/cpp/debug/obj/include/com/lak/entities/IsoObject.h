...
class HXCPP_CLASS_ATTRIBUTES IsoObject_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"com.lak.entities.IsoObject"); }
		static hx::ObjectPtr< IsoObject_obj > __new();
		static hx::ObjectPtr< IsoObject_obj > __alloc(hx::Ctx *_hx_ctx);
