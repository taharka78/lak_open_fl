...
class HXCPP_CLASS_ATTRIBUTES IsoUtils_obj : public hx::Object
{
	...
	public:
		...
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,false,"com.lak.utils.IsoUtils"); }

		hx::ObjectPtr< IsoUtils_obj > __new() {
			hx::ObjectPtr< IsoUtils_obj > __this = new IsoUtils_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< IsoUtils_obj > __alloc(hx::Ctx *_hx_ctx) {
			IsoUtils_obj *__this = (IsoUtils_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(IsoUtils_obj), false, "com.lak.utils.IsoUtils"));
			*(void **)__this = IsoUtils_obj::_hx_vtable;
			return __this;
		}
