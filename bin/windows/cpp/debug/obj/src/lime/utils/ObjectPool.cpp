...
HXLINE( 126)		if (!(this->_hx___pool->exists(object))) {
...
HXLINE( 130)			if (!(( (bool)(this->_hx___pool->get(object)) ))) {
...
HXLINE( 156)		this->_hx___pool->set(object,false);
...
HXLINE( 211)		this->_hx___pool->set(object,true);
