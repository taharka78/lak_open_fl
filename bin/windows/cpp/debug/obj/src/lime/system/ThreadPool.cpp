...
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_108_sendComplete,"lime.system.ThreadPool","sendComplete",0x5f287f63,"lime.system.ThreadPool.sendComplete","lime/system/ThreadPool.hx",108,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_124_sendError,"lime.system.ThreadPool","sendError",0xc461dede,"lime.system.ThreadPool.sendError","lime/system/ThreadPool.hx",124,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_140_sendProgress,"lime.system.ThreadPool","sendProgress",0x658b7657,"lime.system.ThreadPool.sendProgress","lime/system/ThreadPool.hx",140,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_160___doWork,"lime.system.ThreadPool","__doWork",0xcfdf765e,"lime.system.ThreadPool.__doWork","lime/system/ThreadPool.hx",160,0x8993fbb2)
HX_LOCAL_STACK_FRAME(_hx_pos_b98885ed80fb7e2e_181___update,"lime.system.ThreadPool","__update",0x37e4556b,"lime.system.ThreadPool.__update","lime/system/ThreadPool.hx",181,0x8993fbb2)
namespace lime{
...
HXLINE(  74)			_hx_tmp = !(this->_hx___synchronous);
            		}
            		else {
HXLINE(  74)			_hx_tmp = false;
            		}
HXDLIN(  74)		if (_hx_tmp) {
HXLINE(  76)			 ::cpp::vm::Deque _hx_tmp1 = this->_hx___workIncoming;
HXDLIN(  76)			_hx_tmp1->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn(),state));
HXLINE(  77)			this->_hx___workQueued++;
HXLINE(  79)			bool _hx_tmp2;
HXDLIN(  79)			if ((this->currentThreads < this->maxThreads)) {
HXLINE(  79)				int _hx_tmp3 = this->currentThreads;
HXDLIN(  79)				_hx_tmp2 = (_hx_tmp3 < (this->_hx___workQueued - this->_hx___workCompleted));
            			}
            			else {
...
HXLINE(  86)			if (!(::lime::app::Application_obj::current->onUpdate->has(this->_hx___update_dyn()))) {
HXLINE(  88)				::lime::app::Application_obj::current->onUpdate->add(this->_hx___update_dyn(),null(),null());
            			}
            		}
            		else {
HXLINE(  94)			this->_hx___synchronous = true;
HXLINE(  95)			this->doWork->dispatch(state);
            		}
            	}
...
void ThreadPool_obj::sendComplete( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_108_sendComplete)
HXLINE( 111)		if (!(this->_hx___synchronous)) {
HXLINE( 113)			 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
HXDLIN( 113)			_hx_tmp->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE_dyn(),state));
HXLINE( 114)			return;
            		}
HXLINE( 119)		this->onComplete->dispatch(state);
            	}
...
void ThreadPool_obj::sendError( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_124_sendError)
HXLINE( 127)		if (!(this->_hx___synchronous)) {
HXLINE( 129)			 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
HXDLIN( 129)			_hx_tmp->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::ERROR_dyn(),state));
HXLINE( 130)			return;
            		}
HXLINE( 135)		this->onError->dispatch(state);
            	}
...
void ThreadPool_obj::sendProgress( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_140_sendProgress)
HXLINE( 143)		if (!(this->_hx___synchronous)) {
HXLINE( 145)			 ::cpp::vm::Deque _hx_tmp = this->_hx___workResult;
HXDLIN( 145)			_hx_tmp->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::PROGRESS_dyn(),state));
HXLINE( 146)			return;
            		}
HXLINE( 151)		this->onProgress->dispatch(state);
            	}
...
void ThreadPool_obj::_hx___doWork(){
            	HX_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_160___doWork)
HXLINE( 160)		while(true){
HXLINE( 162)			 ::lime::_hx_system::_ThreadPool::ThreadPoolMessage message = this->_hx___workIncoming->pop(true).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
HXLINE( 164)			if (hx::IsEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::WORK_dyn() )) {
HXLINE( 166)				this->doWork->dispatch(message->state);
            			}
            			else {
HXLINE( 168)				if (hx::IsEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn() )) {
...
void ThreadPool_obj::_hx___update(int deltaTime){
            	HX_GC_STACKFRAME(&_hx_pos_b98885ed80fb7e2e_181___update)
HXLINE( 181)		if ((this->_hx___workQueued > this->_hx___workCompleted)) {
HXLINE( 183)			 ::lime::_hx_system::_ThreadPool::ThreadPoolMessage message = this->_hx___workResult->pop(false).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
HXLINE( 185)			while(hx::IsNotNull( message )){
HXLINE( 187)				{
HXLINE( 187)					 ::lime::_hx_system::_ThreadPool::ThreadPoolMessageType _g = message->type;
HXDLIN( 187)					switch((int)(_hx_getEnumValueIndex(_g))){
            						case (int)0: case (int)1: {
HXLINE( 195)							this->_hx___workCompleted++;
HXLINE( 197)							bool _hx_tmp;
HXDLIN( 197)							int _hx_tmp1 = this->currentThreads;
HXDLIN( 197)							if ((_hx_tmp1 <= (this->_hx___workQueued - this->_hx___workCompleted))) {
HXLINE( 197)								_hx_tmp = (this->currentThreads > this->maxThreads);
            							}
            							else {
HXLINE( 197)								_hx_tmp = true;
            							}
HXDLIN( 197)							if (_hx_tmp) {
HXLINE( 199)								this->currentThreads--;
HXLINE( 200)								 ::cpp::vm::Deque _hx_tmp2 = this->_hx___workIncoming;
HXDLIN( 200)								_hx_tmp2->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn(),null()));
            							}
HXLINE( 204)							if (hx::IsEq( message->type,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::COMPLETE_dyn() )) {
HXLINE( 206)								this->onComplete->dispatch(message->state);
            							}
            							else {
HXLINE( 210)								this->onError->dispatch(message->state);
            							}
            						}
            						break;
            						case (int)3: {
HXLINE( 191)							this->onProgress->dispatch(message->state);
            						}
            						break;
            						default:{
            						}
...
HXLINE( 218)				message = this->_hx___workResult->pop(false).StaticCast<  ::lime::_hx_system::_ThreadPool::ThreadPoolMessage >();
            			}
            		}
            		else {
HXLINE( 226)			bool _hx_tmp3;
HXDLIN( 226)			if ((this->currentThreads == (int)0)) {
HXLINE( 226)				_hx_tmp3 = (this->minThreads <= (int)0);
            			}
            			else {
HXLINE( 226)				_hx_tmp3 = false;
            			}
HXDLIN( 226)			if (_hx_tmp3) {
HXLINE( 228)				::lime::app::Application_obj::current->onUpdate->remove(this->_hx___update_dyn());
            			}
            		}
            	}
