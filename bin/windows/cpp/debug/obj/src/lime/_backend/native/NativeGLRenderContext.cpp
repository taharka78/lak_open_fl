...
HXLINE( 780)		int program1;
HXDLIN( 780)		if (hx::IsNull( program )) {
HXLINE( 780)			program1 = (int)0;
            		}
            		else {
HXLINE( 780)			program1 = program->id;
            		}
...
HXLINE( 865)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_blend_color(red,green,blue,alpha);
            	}
...
HXLINE( 874)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_blend_equation(mode);
            	}
...
HXLINE( 883)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_blend_equation_separate(modeRGB,modeAlpha);
            	}
...
HXLINE( 892)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_blend_func(sfactor,dfactor);
            	}
...
HXLINE( 901)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_blend_func_separate(srcRGB,dstRGB,srcAlpha,dstAlpha);
            	}
...
HXLINE( 916)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_buffer_data(target,size,srcData,usage);
            	}
...
HXLINE( 925)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_buffer_sub_data(target,dstByteOffset,size,srcData);
            	}
...
HXLINE( 934)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_check_framebuffer_status(target);
            	}
...
HXLINE( 945)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_clear(mask);
            	}
...
HXLINE( 978)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_clear_color(red,green,blue,alpha);
            	}
...
HXLINE( 987)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_clear_depthf(depth);
            	}
...
HXLINE( 996)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_clear_stencil(s);
            	}
...
HXLINE(1012)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_color_mask(red,green,blue,alpha);
            	}
...
HXLINE(1021)		int shader1;
HXDLIN(1021)		if (hx::IsNull( shader )) {
HXLINE(1021)			shader1 = (int)0;
            		}
            		else {
HXLINE(1021)			shader1 = shader->id;
            		}
...
HXLINE(1030)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_compressed_tex_image_2d(target,level,internalformat,width,height,border,imageSize,data);
            	}
...
HXLINE(1045)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_compressed_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,imageSize,data);
            	}
...
HXLINE(1066)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_copy_tex_image_2d(target,level,internalformat,x,y,width,height,border);
            	}
...
HXLINE(1075)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_copy_tex_sub_image_2d(target,level,xoffset,yoffset,x,y,width,height);
            	}
...
HXLINE(1208)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_cull_face(mode);
            	}
...
HXLINE(1307)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_depth_func(func);
            	}
...
HXLINE(1316)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_depth_mask(flag);
            	}
...
HXLINE(1325)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_depth_rangef(zNear,zFar);
            	}
...
HXLINE(1349)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_disable(cap);
            	}
...
HXLINE(1358)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_disable_vertex_attrib_array(index);
            	}
...
HXLINE(1367)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_draw_arrays(mode,first,count);
            	}
...
HXLINE(1388)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_draw_elements(mode,count,type,offset);
            	}
...
HXLINE(1409)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_enable(cap);
            	}
...
HXLINE(1418)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_enable_vertex_attrib_array(index);
            	}
...
HXLINE(1446)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_finish();
            	}
...
HXLINE(1455)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_flush();
            	}
...
HXLINE(1464)		int renderbuffer1;
HXDLIN(1464)		if (hx::IsNull( renderbuffer )) {
HXLINE(1464)			renderbuffer1 = (int)0;
            		}
            		else {
HXLINE(1464)			renderbuffer1 = renderbuffer->id;
            		}
...
HXLINE(1473)		int texture1;
HXDLIN(1473)		if (hx::IsNull( texture )) {
HXLINE(1473)			texture1 = (int)0;
            		}
            		else {
HXLINE(1473)			texture1 = texture->id;
            		}
...
HXLINE(1488)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_front_face(mode);
            	}
...
HXLINE(1497)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_generate_mipmap(target);
            	}
...
HXLINE(1570)		int program1;
HXDLIN(1570)		if (hx::IsNull( program )) {
HXLINE(1570)			program1 = (int)0;
            		}
            		else {
HXLINE(1570)			program1 = program->id;
            		}
...
HXLINE(1581)		int program1;
HXDLIN(1581)		if (hx::IsNull( program )) {
HXLINE(1581)			program1 = (int)0;
            		}
            		else {
HXLINE(1581)			program1 = program->id;
            		}
...
HXLINE(1592)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_boolean(pname);
            	}
...
HXLINE(1603)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_booleanv(pname,params);
            	}
...
HXLINE(1611)		return this->getBufferParameteri(target,pname);
            	}
...
HXLINE(1619)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_buffer_parameteri(target,pname);
            	}
...
HXLINE(1636)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_buffer_parameteriv(target,pname,data);
            	}
...
HXLINE(1644)		return ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromInt((int)0);
            	}
...
HXLINE(1673)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_error();
            	}
...
HXLINE(1725)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_float(pname);
            	}
...
HXLINE(1736)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_floatv(pname,params);
            	}
...
HXLINE(1771)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_framebuffer_attachment_parameteri(target,attachment,pname);
            	}
...
HXLINE(1782)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_framebuffer_attachment_parameteriv(target,attachment,pname,params);
            	}
...
HXLINE(1798)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_integer(pname);
            	}
...
HXLINE(1808)		return ( ::cpp::Int64Struct((int)0));
            	}
...
HXLINE(1815)		return ( ::cpp::Int64Struct((int)0));
            	}
...
HXLINE(1848)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_integerv(pname,params);
            	}
...
HXLINE(1965)		int program1;
HXDLIN(1965)		if (hx::IsNull( program )) {
HXLINE(1965)			program1 = (int)0;
            		}
            		else {
HXLINE(1965)			program1 = program->id;
            		}
...
HXLINE(1976)		int program1;
HXDLIN(1976)		if (hx::IsNull( program )) {
HXLINE(1976)			program1 = (int)0;
            		}
            		else {
HXLINE(1976)			program1 = program->id;
            		}
...
HXLINE(1992)		int program1;
HXDLIN(1992)		if (hx::IsNull( program )) {
HXLINE(1992)			program1 = (int)0;
            		}
            		else {
HXLINE(1992)			program1 = program->id;
            		}
...
HXLINE(2002)		int _hx_tmp;
HXDLIN(2002)		if (hx::IsNull( program )) {
HXLINE(2002)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE(2002)			_hx_tmp = program->id;
            		}
...
HXLINE(2051)		return this->getRenderbufferParameteri(target,pname);
            	}
...
HXLINE(2059)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_renderbuffer_parameteri(target,pname);
            	}
...
HXLINE(2070)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_renderbuffer_parameteriv(target,pname,params);
            	}
...
HXLINE(2112)		int shader1;
HXDLIN(2112)		if (hx::IsNull( shader )) {
HXLINE(2112)			shader1 = (int)0;
            		}
            		else {
HXLINE(2112)			shader1 = shader->id;
            		}
...
HXLINE(2123)		int shader1;
HXDLIN(2123)		if (hx::IsNull( shader )) {
HXLINE(2123)			shader1 = (int)0;
            		}
            		else {
HXLINE(2123)			shader1 = shader->id;
            		}
...
HXLINE(2132)		int shader1;
HXDLIN(2132)		if (hx::IsNull( shader )) {
HXLINE(2132)			shader1 = (int)0;
            		}
            		else {
HXLINE(2132)			shader1 = shader->id;
            		}
...
HXLINE(2142)		int _hx_tmp;
HXDLIN(2142)		if (hx::IsNull( shader )) {
HXLINE(2142)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE(2142)			_hx_tmp = shader->id;
            		}
...
HXLINE(2162)		int shader1;
HXDLIN(2162)		if (hx::IsNull( shader )) {
HXLINE(2162)			shader1 = (int)0;
            		}
            		else {
HXLINE(2162)			shader1 = shader->id;
            		}
...
HXLINE(2173)		return ( ( ::Dynamic)(::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_string(pname)) );
            	}
...
HXLINE(2268)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_tex_parameterf(target,pname);
            	}
...
HXLINE(2279)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_tex_parameterfv(target,pname,params);
            	}
...
HXLINE(2288)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_tex_parameteri(target,pname);
            	}
...
HXLINE(2299)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_tex_parameteriv(target,pname,params);
            	}
...
HXLINE(2399)		int program1;
HXDLIN(2399)		if (hx::IsNull( program )) {
HXLINE(2399)			program1 = (int)0;
            		}
            		else {
HXLINE(2399)			program1 = program->id;
            		}
...
HXLINE(2410)		int program1;
HXDLIN(2410)		if (hx::IsNull( program )) {
HXLINE(2410)			program1 = (int)0;
            		}
            		else {
HXLINE(2410)			program1 = program->id;
            		}
...
HXLINE(2419)		int program1;
HXDLIN(2419)		if (hx::IsNull( program )) {
HXLINE(2419)			program1 = (int)0;
            		}
            		else {
HXLINE(2419)			program1 = program->id;
            		}
...
HXLINE(2430)		int program1;
HXDLIN(2430)		if (hx::IsNull( program )) {
HXLINE(2430)			program1 = (int)0;
            		}
            		else {
HXLINE(2430)			program1 = program->id;
            		}
...
HXLINE(2466)		int program1;
HXDLIN(2466)		if (hx::IsNull( program )) {
HXLINE(2466)			program1 = (int)0;
            		}
            		else {
HXLINE(2466)			program1 = program->id;
            		}
...
HXLINE(2476)		return this->getVertexAttribi(index,pname);
            	}
...
HXLINE(2498)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_vertex_attribi(index,pname);
            	}
...
HXLINE(2535)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_vertex_attribiv(index,pname,params);
            	}
...
HXLINE(2544)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_get_vertex_attrib_pointerv(index,pname);
            	}
...
HXLINE(2555)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_hint(target,mode);
            	}
...
HXLINE(2576)		int buffer1;
HXDLIN(2576)		if (hx::IsNull( buffer )) {
HXLINE(2576)			buffer1 = (int)0;
            		}
            		else {
HXLINE(2576)			buffer1 = buffer->id;
            		}
...
HXLINE(2586)		return this->_hx___isContextLost;
            	}
...
HXLINE(2594)		return ::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_is_enabled(cap);
            	}
...
HXLINE(2605)		int framebuffer1;
HXDLIN(2605)		if (hx::IsNull( framebuffer )) {
HXLINE(2605)			framebuffer1 = (int)0;
            		}
            		else {
HXLINE(2605)			framebuffer1 = framebuffer->id;
            		}
...
HXLINE(2616)		int program1;
HXDLIN(2616)		if (hx::IsNull( program )) {
HXLINE(2616)			program1 = (int)0;
            		}
            		else {
HXLINE(2616)			program1 = program->id;
            		}
...
HXLINE(2634)		int renderbuffer1;
HXDLIN(2634)		if (hx::IsNull( renderbuffer )) {
HXLINE(2634)			renderbuffer1 = (int)0;
            		}
            		else {
HXLINE(2634)			renderbuffer1 = renderbuffer->id;
            		}
...
HXLINE(2652)		int shader1;
HXDLIN(2652)		if (hx::IsNull( shader )) {
HXLINE(2652)			shader1 = (int)0;
            		}
            		else {
HXLINE(2652)			shader1 = shader->id;
            		}
...
HXLINE(2670)		int texture1;
HXDLIN(2670)		if (hx::IsNull( texture )) {
HXLINE(2670)			texture1 = (int)0;
            		}
            		else {
HXLINE(2670)			texture1 = texture->id;
            		}
...
HXLINE(2695)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_line_width(width);
            	}
...
HXLINE(2704)		int program1;
HXDLIN(2704)		if (hx::IsNull( program )) {
HXLINE(2704)			program1 = (int)0;
            		}
            		else {
HXLINE(2704)			program1 = program->id;
            		}
...
HXLINE(2725)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_pixel_storei(pname,param);
            	}
...
HXLINE(2734)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_polygon_offset(factor,units);
            	}
...
HXLINE(2763)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_read_pixels(x,y,width,height,format,type,pixels);
            	}
...
HXLINE(2779)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_renderbuffer_storage(target,internalformat,width,height);
            	}
...
HXLINE(2800)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_sample_coverage(value,invert);
            	}
...
HXLINE(2821)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_scissor(x,y,width,height);
            	}
...
HXLINE(2837)		int shader1;
HXDLIN(2837)		if (hx::IsNull( shader )) {
HXLINE(2837)			shader1 = (int)0;
            		}
            		else {
HXLINE(2837)			shader1 = shader->id;
            		}
...
HXLINE(2846)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_stencil_func(func,ref,mask);
            	}
...
HXLINE(2855)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_stencil_func_separate(face,func,ref,mask);
            	}
...
HXLINE(2864)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_stencil_mask(mask);
            	}
...
HXLINE(2873)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_stencil_mask_separate(face,mask);
            	}
...
HXLINE(2882)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_stencil_op(fail,zfail,zpass);
            	}
...
HXLINE(2891)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_stencil_op_separate(face,fail,zfail,zpass);
            	}
...
HXLINE(2900)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_tex_image_2d(target,level,internalformat,width,height,border,format,type,data);
            	}
...
HXLINE(2927)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_tex_parameterf(target,pname,param);
            	}
...
HXLINE(2936)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_tex_parameteri(target,pname,param);
            	}
...
HXLINE(2945)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_tex_sub_image_2d(target,level,xoffset,yoffset,width,height,format,type,pixels);
            	}
...
HXLINE(2966)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform1f(location,v0);
            	}
...
HXLINE(2975)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform1fv(location,count,v);
            	}
...
HXLINE(2984)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform1i(location,v0);
            	}
...
HXLINE(2993)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform1iv(location,count,v);
            	}
...
HXLINE(3014)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform2f(location,v0,v1);
            	}
...
HXLINE(3023)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform2fv(location,count,v);
            	}
...
HXLINE(3032)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform2i(location,v0,v1);
            	}
...
HXLINE(3041)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform2iv(location,count,v);
            	}
...
HXLINE(3062)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform3f(location,v0,v1,v2);
            	}
...
HXLINE(3071)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform3fv(location,count,v);
            	}
...
HXLINE(3080)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform3i(location,v0,v1,v2);
            	}
...
HXLINE(3089)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform3iv(location,count,v);
            	}
...
HXLINE(3110)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform4f(location,v0,v1,v2,v3);
            	}
...
HXLINE(3119)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform4fv(location,count,v);
            	}
...
HXLINE(3128)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform4i(location,v0,v1,v2,v3);
            	}
...
HXLINE(3137)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform4iv(location,count,v);
            	}
...
HXLINE(3164)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform_matrix2fv(location,count,transpose,v);
            	}
...
HXLINE(3185)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform_matrix3fv(location,count,transpose,v);
            	}
...
HXLINE(3206)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_uniform_matrix4fv(location,count,transpose,v);
            	}
...
HXLINE(3245)		int program1;
HXDLIN(3245)		if (hx::IsNull( program )) {
HXLINE(3245)			program1 = (int)0;
            		}
            		else {
HXLINE(3245)			program1 = program->id;
            		}
...
HXLINE(3254)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_vertex_attrib1f(index,v0);
            	}
...
HXLINE(3263)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_vertex_attrib1fv(index,v);
            	}
...
HXLINE(3272)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_vertex_attrib2f(index,v0,y);
            	}
...
HXLINE(3281)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_vertex_attrib2fv(index,v);
            	}
...
HXLINE(3290)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_vertex_attrib3f(index,v0,v1,v2);
            	}
...
HXLINE(3299)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_vertex_attrib3fv(index,v);
            	}
...
HXLINE(3308)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_vertex_attrib4f(index,v0,v1,v2,v3);
            	}
...
HXLINE(3317)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_vertex_attrib4fv(index,v);
            	}
...
HXLINE(3366)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_vertex_attrib_pointer(index,size,type,normalized,stride,offset);
            	}
...
HXLINE(3375)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_gl_viewport(x,y,width,height);
            	}
...
HXLINE(3403)		return  ::lime::graphics::opengl::GLObject_obj::__alloc( HX_CTX ,id);
            	}
...
HXLINE(3410)		if (hx::IsNull( object )) {
HXLINE(3410)			return (int)0;
            		}
            		else {
HXLINE(3410)			return object->id;
            		}
