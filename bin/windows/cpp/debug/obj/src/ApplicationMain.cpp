...
HXLINE(  23)		::String projectName = HX_("lakhaxe",7c,5f,94,34);
HXLINE(  25)		 ::Dynamic config =  ::Dynamic(hx::Anon_obj::Create(9)
            			->setFixed(0,HX_("company",3d,15,69,83),HX_("Youssouf & Moussa Sissoko",84,ef,61,2c))
            			...
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(21)
            				...
            				->setFixed(3,HX_("width",06,b6,62,ca),(int)1024)
            				...
            				->setFixed(8,HX_("height",e7,07,4c,02),(int)768)
            				->setFixed(9,HX_("title",98,15,3b,10),HX_("LAK",36,e4,39,00))
            			...
            			->setFixed(5,HX_("packageName",f1,04,ad,04),HX_("com.lakhaxe",4f,0a,bc,82))
            			->setFixed(6,HX_("file",7c,ce,bb,43),HX_("lakhaxe",7c,5f,94,34))
            			->setFixed(7,HX_("name",4b,72,ff,48),HX_("LAK",36,e4,39,00))
