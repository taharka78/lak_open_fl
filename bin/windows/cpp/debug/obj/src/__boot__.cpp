...
::com::lak::simulator::Astar_obj::__register();
::openfl::text::TextField_obj::__register();
::com::lak::controllers::events::UnitEvent_obj::__register();
::com::lak::controllers::events::MapEvent_obj::__register();
...
::com::lak::simulator::pools::IsoUnitPool_obj::__register();
::com::lak::simulator::manager::SpritesheetManager_obj::__register();
::com::lak::simulator::manager::LevelManager_obj::__register();
::com::lak::simulator::manager::EntitiesManager_obj::__register();
::com::lak::simulator::manager::AttackMananger_obj::__register();
::com::lak::simulator::manager::ArmyManager_obj::__register();
::com::lak::simulator::gamestate::InitialState_obj::__register();
::com::lak::simulator::gamestate::IGameState_obj::__register();
::com::lak::simulator::Simulator_obj::__register();
::com::lak::renderers::Renderer_obj::__register();
::com::lak::entities::IsoUnit_obj::__register();
::com::lak::entities::IsoObject_obj::__register();
::com::lak::display::SelectionSprite_obj::__register();
::com::lak::display::FPS_Mem_obj::__register();
::com::lak::controllers::UnitController_obj::__register();
::com::lak::controllers::GameStateController_obj::__register();
...
::com::lak::controllers::events::MapEvent_obj::__boot();
::com::lak::controllers::events::UnitEvent_obj::__boot();
::openfl::text::TextField_obj::__boot();
::com::lak::simulator::Astar_obj::__boot();
