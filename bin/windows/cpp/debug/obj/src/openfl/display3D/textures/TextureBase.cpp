...
HXLINE( 146)			if (this->_hx___outputTextureMemoryUsage) {
HXLINE( 148)				 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 148)				_hx_tmp((((HX_(" - Texture Compressed GPU Memory (-",49,69,39,9f) + this->_hx___compressedMemoryUsage) + HX_(") - Current Compressed Memory : ",57,0f,3e,e9)) + currentCompressedMemory),hx::SourceInfo(HX_("TextureBase.hx",d2,8f,e6,f9),148,HX_("openfl.display3D.textures.TextureBase",2f,94,15,bc),HX_("dispose",9f,80,4c,bb)));
            			}
...
HXLINE( 163)			if (this->_hx___outputTextureMemoryUsage) {
HXLINE( 165)				 ::Dynamic _hx_tmp1 = ::haxe::Log_obj::trace;
HXDLIN( 165)				_hx_tmp1((((HX_(" - Texture GPU Memory (-",18,e7,63,6e) + this->_hx___memoryUsage) + HX_(") - Current Memory : ",54,49,b1,89)) + currentMemory),hx::SourceInfo(HX_("TextureBase.hx",d2,8f,e6,f9),165,HX_("openfl.display3D.textures.TextureBase",2f,94,15,bc),HX_("dispose",9f,80,4c,bb)));
            			}
...
HXLINE( 343)		if (this->_hx___outputTextureMemoryUsage) {
HXLINE( 345)			 ::Dynamic _hx_tmp1 = ::haxe::Log_obj::trace;
HXDLIN( 345)			_hx_tmp1((((HX_(" + Texture Compressed GPU Memory (+",89,af,31,8f) + memory) + HX_(") - Current Compressed Memory : ",57,0f,3e,e9)) + currentCompressedMemory),hx::SourceInfo(HX_("TextureBase.hx",d2,8f,e6,f9),345,HX_("openfl.display3D.textures.TextureBase",2f,94,15,bc),HX_("__trackCompressedMemoryUsage",f4,85,3d,76)));
            		}
...
HXLINE( 367)		if (this->_hx___outputTextureMemoryUsage) {
HXLINE( 369)			 ::Dynamic _hx_tmp1 = ::haxe::Log_obj::trace;
HXDLIN( 369)			_hx_tmp1((((HX_(" + Texture GPU Memory (+",94,55,fe,6d) + memory) + HX_(") - Current Memory : ",54,49,b1,89)) + currentMemory),hx::SourceInfo(HX_("TextureBase.hx",d2,8f,e6,f9),369,HX_("openfl.display3D.textures.TextureBase",2f,94,15,bc),HX_("__trackMemoryUsage",b5,60,9b,9e)));
            		}
            	}
