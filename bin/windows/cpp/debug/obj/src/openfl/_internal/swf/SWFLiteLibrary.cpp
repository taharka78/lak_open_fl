...
HXLINE( 136)		if (hx::IsNotNull( this->swf )) {
HXLINE( 136)			return this->swf->createMovieClip(id);
            		}
            		else {
...
HXLINE( 148)		 ::openfl::_internal::swf::SWFLiteLibrary _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 229)		 ::openfl::_internal::swf::SWFLiteLibrary _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 326)		return this->super::load();
            	}
...
HXLINE( 333)		return this->super::loadImage(id);
            	}
