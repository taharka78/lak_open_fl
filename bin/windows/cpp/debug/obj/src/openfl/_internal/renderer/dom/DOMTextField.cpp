...
HXLINE( 364)		if (hx::IsNotNull( regex->matched((int)2) )) {
HXLINE( 364)			return regex->matched((int)2);
            		}
            		else {
HXLINE( 364)			return regex->matched((int)3);
            		}
...
HXLINE(  26)		_hx___regexSize =  ::EReg_obj::__alloc( HX_CTX ,HX_("size=(\"([^\"]+)\"|'([^']+)')",42,27,be,87),HX_("i",69,00,00,00));
            	}
}
