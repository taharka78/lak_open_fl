...
HXLINE(  40)		::openfl::Lib_obj::notImplemented(hx::SourceInfo(HX_("System.hx",0f,4b,4f,ec),40,HX_("openfl.system.System",50,91,b1,f6),HX_("pause",f6,d6,57,bd)));
            	}
...
HXLINE(  47)		::openfl::Lib_obj::notImplemented(hx::SourceInfo(HX_("System.hx",0f,4b,4f,ec),47,HX_("openfl.system.System",50,91,b1,f6),HX_("resume",ad,69,84,08)));
            	}
...
HXLINE(  83)		return HX_("1.0.0",b5,d1,2e,55);
            	}
